...
// Global state of the app, which is for
// Search Object, Current Recipe Object, Shopping List object and Liked Recipes 
const state = {};
...
const controlSearch = async () => {
    ...
    if (query) {
        ...
        try {
            ...
            alert("Couldn't fetch recipe list");
            clearLoader();
        }
    }
};
...
// Event listender for when next/prev button is clicked
